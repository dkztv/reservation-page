...
export class ReservationService {
  ...
  getActualSlots(count: number = 2) : Observable<Array<string>> {
    const URL = `https://hostme-services-qa.azurewebsites.net/api/core/mb/restaurants/4530/availability?date=2020-11-25T12:00:00%2B03:00&partySize=${count}&rangeInMinutes=720`;
